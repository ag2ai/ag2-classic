...
For lightweight LLM-driven sub-agent delegation see [Subagents](subagents.md) — that's a different feature that wraps an Agent in a `#!python run_subtask` tool.
