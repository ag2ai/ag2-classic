...
Previously, in our [Cross-Framework LLM Tool Integration](/docs/blog/2024/12/20/Tools-interoperability) guide, we combined tools from frameworks like **LangChain** and **PydanticAI** to enhance AG2.
