...
AG2 Classic is the original AG2 framework — `autogen.agentchat` with `ConversableAgent`, `GroupChat`, `LLMConfig`, and the surrounding agents, tools, and capabilities. It is published on PyPI as the `autogen` package and lives in the [ag2-classic](https://github.com/ag2ai/ag2-classic) repository.
...
- **The original framework became AG2 Classic** — it continues as the `autogen` package in maintenance mode, developed in the [ag2-classic](https://github.com/ag2ai/ag2-classic) repository.
